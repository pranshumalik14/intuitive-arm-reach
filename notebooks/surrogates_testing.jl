...
# ╔═╡ 35fef220-adf9-11ec-31de-5db689a8ff81
using Surrogates, CSV, DataFrames, Flux, Statistics, LinearAlgebra;

# ╔═╡ 97699c5c-b661-4aab-9f66-0c936a81fa90
N = 128; B = 5; n = 3;

# ╔═╡ 013cb19d-ef38-498e-a4ef-657135ea5981
md"
...
# ╔═╡ a6488311-0227-4c7e-b2a8-15306348e2dc
begin
	...
	pos_joints = reshape(df_jointpos."0"[n+2+1:end], (n+2, N-1)) |> transpose;
	thetas     = reshape(df_thetas."0"[n*B+1:end], (n*B, N-1)) |> transpose;
end;

# ╔═╡ 1ecc96db-bd98-47da-8fec-9db5b6184126
ub = [maximum(pos_joints[:, i]) for i in 1:size(pos_joints, 2)]

# ╔═╡ 2df8de03-3274-4f3b-aba0-3120c48f9aac
lb = [minimum(pos_joints[:, i]) for i in 1:size(pos_joints, 2)]

# ╔═╡ 3538df52-fe2b-42e3-bfbc-5542075a9d55
md"
...
git-tree-sha1 = "9a86aff5babfe1e4dbd79be47d7a9dfd141e11af"
...
git-tree-sha1 = "45bf52a9fb04350d8771ad694772c18c878683b6"
...
git-tree-sha1 = "8472cc98861d4aec2cd4b7d73ebb97764aa62d24"
...
[[deps.Surrogates]]
deps = ["AbstractGPs", "Distributions", "ExtendableSparse", "Flux", "GLM", "IterativeSolvers", "LatinHypercubeSampling", "LinearAlgebra", "PolyChaos", "Requires", "Sobol", "SparseArrays", "XGBoost", "Zygote"]
git-tree-sha1 = "c6752d2dd8d31d81cdd8c22176c187dc90ef0137"
